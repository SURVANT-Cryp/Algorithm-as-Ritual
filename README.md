...
<i>Algorithm as Ritual</i> is a project exploring the ritualization of human-machine collaboration. The playlists for the show are generated by a computer program written in Python that randomly selects music from an eclectic and continuously growing archive created and maintained by artist Patrick Quinn. Quinn searches far and wide for music to go into the archive, sifting through dusty crates in record stores and the immense flea market that is the Internet. The Python program takes over from there, outputting a browser-based playlist—aleatory in nature. 
